<template>
  <div v-show="showModal" class="modal_form">
    <header class="modal_form__header">
      <div class="header__close_button" tabindex="0">&#xd7;</div>
    ...
    <main class="modal_form__main">
      ...
      <div v-else>
        ...
        <div class="main__conditon_radio">
          <div class="conditon_radio__conditon_button">
            <label class="conditon_button__radio_button">
    ...
    <footer class="modal_form__footer">
  ...
  methods: {
    ...
    giveData() {
      ...
      if (this.typeOperation === "category") {
        if (this.mode === "insert") data.moneyMode = this.moneyMode;
...
.modal_form {
  ...
  .modal_form__main {
    ...
    .main__conditon_radio {
      ...
      .conditon_radio__conditon_button {
